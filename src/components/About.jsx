...
import profile from '../assets/bi2.png'
...
const About = () => {
  return (
    ...
    <div className="py-10 bg-slate-100">
        ...
        <div className="flex py-6 flex-col items-center justify-center md:flex-row">
            <div className="w-full flex justify-center">
                <Image className='rounded-full' width={300} height={300} src={profile} alt='profile' />
            </div>
